...
/**
 * 「Meteor 设置数据类型约束」的版本绑定接口 —— <b>1.21.4</b> 实现。
 *
 * <p>1.21.4 的 Meteor 还没有 {@code IGeneric}，{@code GenericSetting} 的类型约束是
 ...
 * </ul>
 *
 * <p><b>⚠️ 维护提示</b>：本文件与 {@code v1211/compat/StateFilterDataMeteorBinding.java}
 * 除 package 外逐字相同，修改时请同步。
 *
